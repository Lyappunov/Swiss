...
<div style='width: 65%; margin: auto; margin-top:40px; background-color: white;padding: 20px; border-radius: 20px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);'>
    ...
    <div class="row">
        ...
        <div class='col-lg-12' style="text-align: left; padding: 2%;">
    		<p>{!! "Dekkið þitt hefur verið skráð rétt í verslun okkar." !!}</p>
    		<p>{!! "Vinsamlegast athugaðu hvort eftirfarandi atriði eru rétt." !!}</p>
    	</div>
    </div>
    <div class="row">
    	<div class="col-lg-3">
        	<div class="left-area">
            	<h4 class="heading">{!! 'Númeraplata: '.$number_plate !!} </h4>
        	</div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
    	<div class="col-lg-3">
        	<div class="left-area">
            	<h4 class="heading">{!! 'Dekkjastærð : '.$size !!} </h4>
        	</div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
    	<div class="col-lg-3">
        	<div class="left-area">
            	<h4 class="heading">{!! 'Fjöldi dekkja : '.$qty !!} </h4>
        	</div>
        </div>
    </div>
    <div class="row">
    	<div class="col-lg-3">
        	<div class="left-area">
            	...
            	<h4 class="heading">{!! 'Sumar eða Vetrardekk : '.$weather !!} </h4>
        	</div>
        </div>
    </div>
    <div class="row">
    	<div class="col-lg-3">
        	<div class="left-area">
            	<h4 class="heading">{!! 'Á felgu? : '.$is_rim !!} </h4>
        	</div>
        </div>
    </div>
    <div class="row">
    	<div class="col-lg-3">
        	<div class="left-area">
            	...
            	<h4 class="heading">{!! 'Skráð : '.$reg_date !!} </h4>
        	</div>
        </div>
    </div>
