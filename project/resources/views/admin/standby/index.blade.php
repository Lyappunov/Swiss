...
<input type="hidden" id="attribute_data" value="{{ __('ADD NEW ATTRIBUTE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Stand By List') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
											</li>
											<li>
												<a href="{{ route('admin-standby-index') }}">{{ __('Stand By List') }}</a>
											</li>
										</ul>
								</div>
							</div>
                        ...
                        @include('includes.admin.form-success')
										...
										<div class="table-responsiv">
												<table id="standbytable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#standbytable').DataTable({
			   ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-standby-datatables') }}',
               columns: [
