...
<head>
		...
		<link href="{{asset('assets/admin/css/rtl/custom_xzoom.css')}}" rel="stylesheet"/>
		...
		<link href="{{asset('assets/admin/css/custom_xzoom.css')}}" rel="stylesheet"/>
					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between">
							<div class="menu-toggle-button">
								...
								<div>
									<img  src="{{asset('assets/images/logo3.png')}}" alt="" style="width:80px; margin-left:75px;">
								</div>
							</div>
								...
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_product" href="javascript:;">
											<h4 style='color:white;'>{{ Auth::guard('admin')->user()->name }}</h4>
										</a>
									</li>
