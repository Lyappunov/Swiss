...
class DashboardController extends Controller
{
    ...
    {   
        ...
        $working_projects = Project::where('status',1)->get();
        $offer_projects = Project::where('status',3)->get();
        $closed_projects = Project::where('status',2)->get();

        return view('admin.dashboard',compact('projects','customers','working_projects','offer_projects','closed_projects'));
    }
