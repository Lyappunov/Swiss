...
// ************************************ ADMIN SECTION **********************************************
  ...
  Route::group(['middleware'=>'permissions:products'],function(){
    ...
    Route::get('/customer/datatables', 'Admin\CustomerController@datatables')->name('admin-customer-datatables');
    Route::get('/customer/new', 'Admin\CustomerController@create')->name('new-customer');
    Route::post('/customer/create', 'Admin\CustomerController@store')->name('admin-customer-store');
    Route::get('/customer', 'Admin\CustomerController@list')->name('admin-customer-list');
    ...
    Route::get('/customer/delete/{id}', 'Admin\CustomerController@destroy')->name('admin-customer-delete');

    /// Window Project

    Route::get('/project/create', 'Window\ProjectController@new')->name('project-create');
    Route::post('/project/create_new', 'Window\ProjectController@create_new')->name('project-create-new');
    Route::get('/projects', 'Window\ProjectController@index')->name('project-index');

    Route::get('/projects/datatables', 'Window\ProjectController@datatables')->name('all-projects-datatables'); //JSON REQUEST
    Route::get('/projects/datatables/working', 'Window\ProjectController@datatables_working')->name('working-projects-datatables'); //JSON REQUEST
    Route::get('/projects/datatables/offer', 'Window\ProjectController@datatables_offer')->name('offer-projects-datatables'); //JSON REQUEST
    Route::get('/projects/datatables/closed', 'Window\ProjectController@datatables_closed')->name('closed-projects-datatables'); //JSON REQUEST

    Route::get('/projects/status/{id1}/{id2}', 'Window\ProjectController@status')->name('project-status');
    Route::get('/projects/edit/{id}', 'Window\ProjectController@edit')->name('project-edit');
    Route::post('/projects/edit/{id}', 'Window\ProjectController@update')->name('project-update');

    Route::get('/projects/working', 'Window\ProjectController@working')->name('project-working');
    Route::get('/projects/offer', 'Window\ProjectController@offer')->name('project-offer');
  ...
  Route::group(['middleware'=>'permissions:hotel_storage'],function(){
    ...
    //------------ ADMIN HOTELSTORAGE SECTION --------

    Route::get('/hotelstorage/datatables', 'Admin\HotelStorageController@datatables')->name('admin-hotel-datatables'); //JSON REQUEST
    Route::get('/hotelstorage', 'Admin\HotelStorageController@index')->name('admin-hotel-index');
    Route::get('/hotelstorage/create', 'Admin\HotelStorageController@create')->name('admin-hotel-create');
    Route::post('/hotelstorage/create', 'Admin\HotelStorageController@store')->name('admin-hotel-store');
    Route::get('/hotelstorage/edit/{id}', 'Admin\HotelStorageController@edit')->name('admin-hotel-edit');
    Route::post('/hotelstorage/edit/{id}', 'Admin\HotelStorageController@update')->name('admin-hotel-update');
    Route::get('/hotelstorage/delete/{id}', 'Admin\HotelStorageController@destroy')->name('admin-hotel-delete');
    Route::get('/hotelstorage/status/{id1}/{id2}', 'Admin\HotelStorageController@status')->name('admin-hotel-status');

    //------------ ADMIN STORAGE SECTION --------

    Route::get('/storage/datatables', 'Admin\StorageController@datatables')->name('admin-storage-datatables'); //JSON REQUEST
    Route::get('/storage/condatatables/{id}', 'Admin\StorageController@condatatables')->name('admin-storage-condatatables'); //JSON REQUEST
    Route::get('/storage/condatatables_picked/{id}', 'Admin\StorageController@condatatables_picked')->name('admin-storage-condatatables_picked'); //JSON REQUEST
    Route::get('/storage', 'Admin\StorageController@index')->name('admin-storage-index');
    Route::get('/storage/addstore/{id}', 'Admin\StorageController@create')->name('admin-storage-create');
    Route::get('/storage/conindex/{id}', 'Admin\StorageController@conindex')->name('admin-storage-conindex');
    Route::post('/storage/create', 'Admin\StorageController@store')->name('admin-storage-store');
    Route::get('/storage/details/{id}', 'Admin\StorageController@details')->name('admin-storage-details');
    Route::post('/storage/pickup/{id}/{staff}', 'Admin\StorageController@pickup')->name('admin-storage-pickup');
    Route::get('/storage/log/{id}', 'Admin\StorageController@log')->name('admin-storage-log');
    Route::get('/storage/edit/{id}', 'Admin\StorageController@edit')->name('admin-storage-edit');
    Route::post('/storage/edit/{id}', 'Admin\StorageController@update')->name('admin-storage-update');
    Route::get('/storage/delete/{id}', 'Admin\StorageController@destroy')->name('admin-storage-delete');
    Route::post('/storage/standBy/{id}/{staff}', 'Admin\StorageController@standBy')->name('admin-storage-standby');
    Route::post('/storage/back-to-new/{id}/{staff}', 'Admin\StorageController@backtoNew')->name('admin-storage-backToNew');
    Route::post('/storage/booking/{id}/{staff}', 'Admin\StorageController@booking')->name('admin-storage-booking');
    Route::post('/storage/backstand/{id}/{staff}', 'Admin\StorageController@backstand')->name('admin-storage-backstand');
    Route::post('/storage/backbook/{id}/{staff}', 'Admin\StorageController@backbook')->name('admin-storage-backbook');
    Route::post('/storage/backStandTrash/{id}/{staff}', 'Admin\StorageController@backStandTrash')->name('admin-storage-backStandTrash');
    Route::post('/storage/trash/{id}/{staff}', 'Admin\StorageController@trash')->name('admin-storage-trash');
    Route::get('/storage/print_sticker/{id}', 'Admin\StorageController@print_sticker')->name('admin-storage-sticker');
    Route::get('/storage/print_ticket/{id}', 'Admin\StorageController@print_ticket')->name('admin-storage-ticket');
    Route::post('/storage/email/{id}/{staff}', 'Admin\StorageController@emailsub')->name('admin-storage-emailsub');
    Route::post('/storage/pickedemail/{id}/{staff}', 'Admin\StorageController@pickedemailsub')->name('admin-storage-pickedemailsub');
    Route::post('/storage/saving/{id}/{staff}', 'Admin\StorageController@saving')->name('admin-storage-saving');
    Route::post('/storage/saving-location/{id}/{staff}', 'Admin\StorageController@locationsaving')->name('admin-location-saving');
  ...
  Route::group(['middleware'=>'permissions:booking_list'],function(){
    Route::get('/booking/datatables', 'Admin\BookingController@datatables')->name('admin-booking-datatables'); //JSON REQUEST
    Route::get('/booking', 'Admin\BookingController@index')->name('admin-booking-index');
  });

  //------------ ADMIN BOOKING LIST END --------------------

    //------------ ADMIN PICKED LIST --------------------

    Route::group(['middleware'=>'permissions:old_storage_list'],function(){
      Route::get('/picked/datatables', 'Admin\PickedController@datatables')->name('admin-picked-datatables'); //JSON REQUEST
      Route::get('/picked', 'Admin\PickedController@index')->name('admin-picked-index');
    });
  
    //------------ ADMIN PICKED LIST END --------------------

    //------------ ADMIN NEW LIST --------------------

    Route::group(['middleware'=>'permissions:new_list'],function(){
      Route::get('/new/datatables', 'Admin\NewController@datatables')->name('admin-new-datatables'); //JSON REQUEST
      Route::get('/new', 'Admin\NewController@index')->name('admin-new-index');
    });
    ...
    Route::group(['middleware'=>'permissions:stand_by_list'],function(){
      Route::get('/standby/datatables', 'Admin\StandbyController@datatables')->name('admin-standby-datatables'); //JSON REQUEST
      Route::get('/standby', 'Admin\StandbyController@index')->name('admin-standby-index');
    });

    //------------ ADMIN STAND BY LIST END --------------------

    //------------ ADMIN TRASHED LIST --------------------

    Route::group(['middleware'=>'permissions:trashed_list'],function(){
      Route::get('/trashed/datatables', 'Admin\TrashedController@datatables')->name('admin-trashed-datatables'); //JSON REQUEST
      Route::get('/trashed', 'Admin\TrashedController@index')->name('admin-trashed-index');
    });

    //------------ ADMIN TRASHED LIST END --------------------

    //------------ ADMIN OLDSTORAGE LIST --------------------

    Route::group(['middleware'=>'permissions:old_storage_list'],function(){
      Route::get('/oldstorage/datatables', 'Admin\OldStorageController@datatables')->name('admin-oldstorage-datatables'); //JSON REQUEST
      Route::get('/oldstorage', 'Admin\OldStorageController@index')->name('admin-oldstorage-index');
    });

    //------------ ADMIN OLDSTORAGE LIST END --------------------

  //------------ ADMIN CSV IMPORT SECTION ------------

  Route::group(['middleware'=>'permissions:import_and_export_data'],function(){
    ...
    Route::get('/products/export-submit', 'Admin\ProductController@exportSubmit')->name('admin-prod-exportsubmit');
