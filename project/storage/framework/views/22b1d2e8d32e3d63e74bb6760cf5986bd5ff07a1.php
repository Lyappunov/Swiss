					...
					?>
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"><?php echo e(__('Offerte Bestellung')); ?> <a class="add-btn" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
											<ul class="links">
												<li>
													<a href="javascript:;"><?php echo e(__('Dashboard')); ?> </a>
												</li>
                                                <li>
                                                    <a href="javascript:;"><?php echo e(__('Offerte Bestellung')); ?> </a>
                                                </li>
											</ul>
									</div>
								</div>
