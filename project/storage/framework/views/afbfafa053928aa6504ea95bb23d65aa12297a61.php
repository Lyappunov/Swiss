...
?>
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"><?php echo e(__('Einkauf ')); ?> <a class="add-btn" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
											<ul class="links">
												<li>
													<a href="javascript:;"><?php echo e(__('Dashboard')); ?> </a>
												</li>
                                                <li>
                                                    <a href="javascript:;"><?php echo e(__('Einkauf ')); ?> </a>
                                                </li>
											</ul>
									</div>
								</div>
													...
													<form id="geniusform" action="<?php echo e(route('project-create-new')); ?>" method="POST" enctype="multipart/form-data">
														...
														<div class="row">
															...
															<div class="row">
																	<div class="col-lg-4">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Offerte Firma:')); ?>* </h4>
																		</div>
																	</div>
																	<div class="col-lg-7">
																...
																<div class="row">
																	<div class="col-lg-4">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Adresse:')); ?>* </h4>
																		</div>
																	</div>
																	<div class="col-lg-7">
																...
																<div class="row">
																	<div class="col-lg-4">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Kontakt Person:')); ?>* </h4>
																		</div>
																	</div>
																	<div class="col-lg-7">
																		<input type="text" class="input-field" placeholder="<?php echo e(__('Enter Project Name')); ?>" name="name" required="">
															...
															<div id="table_1" class="table-editable" >
																<table class="table">
																	...
																	<?php for($j=0; $j < sizeof($name_array); $j++): ?>
																		<tr>
																			<td contenteditable="true"><?php echo e($j + 12); ?></td>
																			<td contenteditable="true"><?php echo e($name_array[$j]); ?></td>
