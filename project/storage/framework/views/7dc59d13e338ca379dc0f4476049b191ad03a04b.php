										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="<?php echo e(route('admin-user-edit',$data->id)); ?>" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<select class="input-field" name="country" required>
															<?php echo $__env->make('includes.admin.countries', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
														</select>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="state" placeholder="<?php echo e(__("State")); ?>" required="" value="<?php echo e($data->state); ?>">
													</div>
												</div>
