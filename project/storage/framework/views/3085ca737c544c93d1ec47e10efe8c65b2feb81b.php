...
<?php
	$name_array = array('Rabatt','Netto','Mwst','Total');
?>
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"><?php echo e(__('Offerte & Vertrag')); ?> <a class="add-btn" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
											<ul class="links">
												<li>
													<a href="javascript:;"><?php echo e(__('Dashboard')); ?> </a>
												</li>
                                                <li>
                                                    <a href="javascript:;"><?php echo e(__('Offerte & Vertrag')); ?> </a>
                                                </li>
											</ul>
									</div>
								</div>
														...
														<div class="row">
															...
															<div class="col-lg-12 col-12">
																...
																<div class="row">
																	<div class="col-lg-4">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Offerte Datum')); ?>* </h4>
																		</div>
																	</div>
																	<div class="col-lg-7">
																...
																<div class="row">
																	...
																	<div class="col-lg-7">
																		<input type="text" class="input-field" placeholder="<?php echo e(__('Enter Date')); ?>" name="contact_date" required="" value="">
																	</div>
																</div>
																...
																<div class="row">
																	<div class="col-lg-4">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Gültigkeit')); ?>* </h4>
																		</div>
																	</div>
																	<div class="col-lg-7">
																...
																<div class="row">
																	<div class="col-lg-4">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Ausführungs Termin')); ?>* </h4>
																		</div>
																	</div>
																	<div class="col-lg-7">
																...
																<table class="table">
																	...
																	<?php for($i=1;$i<=10;$i++): ?>
																		<tr>
																			...
																			<th contenteditable="true" colspan='2'></th>
																	...
																	<?php for($i=0; $i < sizeof($name_array); $i++): ?>
																	<tr >
																		<td contenteditable="true"><?php echo e($i + 12); ?></td>
																		<td contenteditable="true"><?php echo e($name_array[$i]); ?></td>
																		<td contenteditable="true"></td>
																		<td contenteditable="true"></td>
																		<td contenteditable="true"></td>
																		<td contenteditable="true"></td>
																		...
																		<?php if($i==1): ?>
																		<th contenteditable="true" colspan='2' rowspan='3'>Netto Marge</th>
																		<?php else: ?>
																		<th contenteditable="true" colspan='2'></th>
																		<?php endif; ?>
