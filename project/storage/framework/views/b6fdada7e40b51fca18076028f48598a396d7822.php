								...
								<div class="row">
                                    ...
                                    <div class="table-responsive show-table">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th><?php echo e(__("Customer Photo")); ?></th>
                                                <td>
                                              <img src="<?php echo e($data->photo ? asset('assets/images/customers/'.$data->photo):asset('assets/images/noimage.png')); ?>" alt="<?php echo e(__("No Image")); ?>">
