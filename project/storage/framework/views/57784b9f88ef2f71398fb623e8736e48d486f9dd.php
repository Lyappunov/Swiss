...
<head>
    	...
    	<link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/bootstrap-datetimepicker.min.css')); ?>">
		...
		<link href="<?php echo e(asset('assets/admin/css/rtl/custom_xzoom.css')); ?>" rel="stylesheet"/>
		...
		<link href="<?php echo e(asset('assets/admin/css/custom_xzoom.css')); ?>" rel="stylesheet"/>
	...
	<body>
					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between">
							<div class="menu-toggle-button">
								...
								<div>
									<img  src="<?php echo e(asset('assets/images/logo3.png')); ?>" alt="" style="width:80px; margin-left:75px;">
								</div>
							</div>
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_product" href="javascript:;">
											<h4 style='color:white;'><?php echo e(Auth::guard('admin')->user()->name); ?></h4>
										</a>
									</li>
        ...
        <script src="<?php echo e(asset('assets/admin/js/bootstrap-datetimepicker.min.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('assets/admin/js/setup.js')); ?>"></script>
