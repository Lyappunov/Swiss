...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__("Projects")); ?></h4>
										<ul class="links">
											<li>
												<a href="javascript:;"><?php echo e(__("Projects")); ?> </a>
											</li>
											<li>
												<a href="<?php echo e(route('project-index')); ?>"><?php echo e(__("Working Projects")); ?></a>
											</li>
										</ul>
								</div>
							</div>
                                            ...
                                            <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(__("Contact Date")); ?></th>
                                                        <th><?php echo e(__("Administrator")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('working-projects-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
