    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="projects" data-parent="#accordion">
            ...
            <li>
                <a href="<?php echo e(route('ordered-projects')); ?>">
                    <span><i class="icofont-address-book"></i>Ordered Projects</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('offered-projects')); ?>">
                    <span><i class="icofont-handshake-deal"></i>Offer & Contracts</span>
                </a>
            </li>
        </ul>
    </li>
