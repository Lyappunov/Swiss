...
// ************************************ ADMIN SECTION **********************************************
  ...
  Route::group(['middleware'=>'permissions:products'],function(){
    ...
    Route::get('/project/ordered_projects', 'Window\ProjectController@ordered_projects')->name('ordered-projects');
    Route::get('/project/offered_projects', 'Window\ProjectController@ordered_projects')->name('offered-projects');
