...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $standby = Storage::where(['is_picked_up'=>0, 'is_booking'=>0])->get();
        $picked = Storage::where(['is_picked_up'=>1])->get();
        $booked = Storage::where(['is_picked_up'=>0, 'is_booking'=>1])->get();
        $trashed = Storage::where(['is_picked_up'=>2])->get();

        $hotel_storage = Hotelstorage::all();
        $storage = Storage::all();
        

        return view('admin.dashboard',compact('hotel_storage','storage', 'standby','picked','booked','trashed','days','sales'));
    }
