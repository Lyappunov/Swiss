								...
								<div class="row">
									<div class="col-lg-12">
											...
											<ul class="links">
												...
												<li>
													<a href="{{ route('admin-staff-index') }}">{{ __('Customers') }}</a>
												</li>
												<li>
													<a href="">{{ __('Create Customer') }}</a>
												</li>
											</ul>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-customer-store') }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="address" placeholder="{{ __('Home Address') }}" required="" value="">
													</div>
												</div>
