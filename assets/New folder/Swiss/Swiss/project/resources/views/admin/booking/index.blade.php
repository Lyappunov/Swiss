...
<input type="hidden" id="attribute_data" value="{{ __('ADD NEW ATTRIBUTE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Booking List') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
											</li>
											<li>
												<a href="{{ route('admin-booking-index') }}">{{ __('Booking List') }}</a>
											</li>
										</ul>
								</div>
							</div>
                        ...
                        @include('includes.admin.form-success')
										...
										<div class="table-responsiv">
												<table id="bookingtable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#bookingtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-booking-datatables') }}',
               columns: [
