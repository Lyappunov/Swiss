...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Old Storage(Picked Up) List') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
											</li>
											<li>
												<a href="{{ route('admin-picked-index') }}">{{ __('Old Storage List') }}</a>
											</li>
										</ul>
								</div>
							</div>
                        ...
                        @include('includes.admin.form-success')
										...
										<div class="table-responsiv">
												<table id="pickedtable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#pickedtable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-picked-datatables') }}',
               columns: [
