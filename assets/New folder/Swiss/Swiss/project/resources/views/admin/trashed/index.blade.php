...
<input type="hidden" id="attribute_data" value="{{ __('ADD NEW ATTRIBUTE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Trashed List') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
											</li>
											<li>
												<a href="{{ route('admin-booking-index') }}">{{ __('Trashed List') }}</a>
											</li>
										</ul>
								</div>
							</div>
                        ...
                        @include('includes.admin.form-success')
										...
										<div class="table-responsiv">
												<table id="trashedtable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#trashedtable').DataTable({
			   ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-trashed-datatables') }}',
               columns: [
