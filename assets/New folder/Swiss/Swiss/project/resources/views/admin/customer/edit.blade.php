...
@section('content')
                        ...
                        @include('includes.admin.form-error') 
											<form id="geniusformdata" action="{{ route('admin-customer-update',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/images/customers/'.$data->photo) : asset('assets/images/noimage.png') }});">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="address" placeholder="{{ __("Home Address") }}" required="" value="{{ $data->address }}">
													</div>	
												</div>
