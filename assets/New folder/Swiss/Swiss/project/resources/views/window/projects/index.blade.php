							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('project-index') }}">{{ __("All Projects") }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('all-projects-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'contact_date', name: 'contact_date' },
                        { data: 'offer_date', name: 'offer_date' },
                        { data: 'appointment_place', name: 'appointment_place' },
                        { data: 'project_number', name: 'project_number' },
                        { data: 'project_administration', name: 'project_administration' },
